    ...
    if users_id:
        if user_id in users_id:
            ...
            tasks = [
                ...
                else asyncio.create_task(add_message_for_pending(user, message_to_chat))
...
async def add_message_for_pending(user_id: int, message_to_chat: Message):
    if user_id in server.pending_messages:
        server.pending_messages[user_id].append(message_to_chat)
    else:
        server.pending_messages.update({user_id: [message_to_chat]})
